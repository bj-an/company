...
<body>
	...
	<div id="mc_embed_signup">
		...
		<form id="joinForm" action="/login/joinupdate.do" method="post">
			...
			<div id="mc_embed_signup_scroll">
				...
				<div class="mc-field-group">
					...
					</label> <input type="text" name="id" class="required text"
						id="id" value="${joininfo2.id}" readonly>
				...
				<div class="mc-field-group">
					...
					<label for="name">이름</label> <input type="text" 
						name="name"  id="name" value="${joininfo2.name}" readonly>

				</div>

				<div class="mc-field-group">

					<label for="phonenum">휴대폰 번호</label> <input type="number" 
						name="phonenum"  id="phonenum" value="${joininfo2.phonenum}"
						required>
				...
				<div style="height: 100px">
					...
					<label for="email">이메일</label><br> <input type="text" 
						name="email" class="" id="email" value="${joininfo2.email}"
						size="50" style="width: 400px"  required>
					<span>@</span> <input type="text" name="email2" id="email2" value="${joininfo2.email2 }"
				...
				<div class="form-group">
					<input class="form-control" style="width: 40%; display: inline;"
						value= "${joininfo2.addr1}" name="addr1" id="addr1" type="text"
						readonly="readonly">
				...
				<div class="form-group">
					<input class="form-control" style="top: 5px;" value= "${joininfo2.addr2}"
						name="addr2" id="addr2" type="text" readonly="readonly" />
				</div>
				<div class="form-group">
					<input class="form-control" value=" ${joininfo2.addr3}" name="addr3"
						id="addr3" type="text" />
				</div>
					<div class="form-group">
					<input class="form-control" value= "${joininfo2.addr4}" name="addr4"
						id="addr4" type="text" />
				</div>


				<input type="submit" value="정보수정" name="join" id="join"
